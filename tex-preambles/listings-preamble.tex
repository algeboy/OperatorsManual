...
{verbatim,colupper=black,colback=black!10,colframe=black!50}
{\IfBooleanT{#1}{\textcolor{red}{\ttfamily\bfseries > }}%
\lstinline[keywordstyle=\color{blue!35!white}\bfseries,columns=fullflexible]{#2}}
...
% \newcommand{\code}[1]{\commandbox*{cd "My Documents"}}
%\lstinline[backgroundcolor=ForestGreen,language=inlinestyle]{#1}}
