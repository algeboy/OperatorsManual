...
\end{enumerate}
Many algebraist spend their careers within just one of these categories and
books on the subject often specialize as well.  There is at
least one major reason this has happened.  Algebra is taught mostly as learning
one family of examples at a time: first it is groups, then rings, then fields, then modules,
