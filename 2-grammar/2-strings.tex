...
data String_abc = nil
                ...
                | 'c' s 
\end{Fcode}
This all gets a bit tedious as we can see there is a 
pattern of \code{<Character> <String>}.  So we 
remedy this by first we fix an alphabet (systems often 
do this for us by convention ASCII, Unicode, or others)
\begin{center}
\code{Char =['a','b',...,'z']}.
\end{center}
Then we introduce a data type that admits these characters.
\begin{Fcode}[]
data String = Empty 
