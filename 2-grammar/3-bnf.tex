...
the notation used today is more formulaic.\index{Panini}

\index{BNF}\index{Backus-Naur Form|@see{BNF}}\index{formal}
...
\index{Walrus}\index{$\defeq$}\index{judgemental}\index{nominal}
...
\index{production rule}\index{Wowed Walrus}\index{::=}\index{tag}
