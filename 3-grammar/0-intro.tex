...
\end{tikzpicture}
\end{center}
We can read the tree like step-by-step instructions (shown chronological left to right).  Start at the leaves and join
...
The domino illustration could bottle up the experience of climbing stairs.  Surely its more fun to climb trees and mountains.
