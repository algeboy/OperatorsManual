...
\subsection{Free algebras/Algebras of formulas}
...
\begin{definition}
    ...
    \code{<Operators>} whose production rules are called \emph{operator signatures}.

    A formula with signature $\sigma$ with variables in an alphabet \code{<Var>} 
...
\begin{definition}
    A \emph{free algebra} of a fixed signature $\sigma$ and variables \code{Var}
